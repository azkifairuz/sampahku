...
export default function Singup() {
  ...
  return (
    <div className="bg-[#D3F0E2] pt-10 flex h-screen flex-col gap-[14px] justify-start px-[46px]">
      ...
      <div className="w-full mx-auto flex flex-col gap-[20px] justify-center px-10 bg-blueMain p-5 rounded-lg">
        <form action="" className="flex justify-center flex-col gap-[10px]">
          <div className="flex flex-col gap-[11px]">
            ...
            <input
              className="rounded-[12px]  outline-none text-sm bg-white h-[35px] p-1"
              type="text"
              id="username"
              name="username"
          ...
          <div className="flex flex-col gap-[11px]">
            ...
            <input
              className="rounded-[12px] outline-none text-sm bg-white h-[35px] p-2"
              type="text"
              id="email"
              name="email"
          ...
          <div className="flex flex-col gap-[11px]">
            <label htmlFor="pw" className="text-white  text-sm ">
              Password
            </label>
            <input
              className="rounded-[12px] outline-none text-sm bg-white h-[35px] p-2"
            ...
            />
            <p className="self-end text-white text-sm">Lupa Password?</p>
          </div>
        </form>
